...
function changePlaces(hallSchemeRows, data, newHallConfigArray) {
  // newHallConfigArray = JSON.parse(JSON.stringify(hallConfigArray));
  console.log("config in changePlaces zero line:", newHallConfigArray);
  if (!newHallConfigArray) {
    newHallConfigArray = JSON.parse(JSON.stringify(hallConfigArray));
  }
  console.log("config in changePlaces first line:", newHallConfigArray);
  console.log("hallSchemeRows in changePlaces first line:", hallSchemeRows);
  console.log("data in changePlaces first line:", data);
  ...
  console.log("config in changePlaces:", newHallConfigArray);
  return newHallConfigArray;
}

// Изменение размера зала

function changeHallSize(newHallConfigArray, data) {
  // console.log("newHallConfigArray changeHallSize in 1st line:", newHallConfigArray);
  hallConfigForm.addEventListener("input", () => {
    ...
    console.log("config in changeHallSize:", newHallConfigArray);

    changePlaces(hallSchemeRows, data, newHallConfigArray);
  })
}
...
function saveConfig(currentHallConfig, newHallConfigArray) {
  ...
  console.log("config in saveConfig:", newHallConfigArray);
...
function hallsOperations(data) {
  ...
  newHallConfigArray = changePlaces(hallSchemeRows, data);
